...
data.forEach((pokemon) => {
    ...
    tipoPokemon.length > 1 ? tipo.innerHTML = `Tipo primário: ${pokemon.types[0]} Tipo secundário: ${pokemon.types[1]}` : tipo.innerHTML = `Tipo primário: ${pokemon.types[0]}`;
    
    // if (tipoPokemon.length > 1) {
    //     tipo.innerHTML = `Tipo primário e secundário: ${pokemon.types[0]} e ${pokemon.types[1]}`
    // } else {
    //     tipo.innerHTML = `Tipo primário: ${pokemon.types[0]}`
    // }
